...
// #define LOAD_PARAMS_ON_LAUNCH    // load previous paramters on launch or not
...
#define DEFAULT_ROWS_IPAD 120
#define DEFAULT_COLUMNS_IPAD 120
...
#define MAX_STARSIZE_IPAD 4.0
#define MAX_ROWS_IPAD 150
...
#define TIME_TO_RESET 30.0f     // time to reset when visualizing
#define TOOLBAR_ALPHA 0.9
